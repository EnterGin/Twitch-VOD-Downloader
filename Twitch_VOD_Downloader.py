#Twitch VOD Downloader v1.2.0 https://github.com/EnterGin/Twitch-VOD-Downloader
...
class TwitchDownloader:
        ...
        try:
            ...
            if e.response != None:
                if e.response.reason == 'Bad Request':
                    ...
                    vod_response_another_error_window = "cmd.exe /c start".split()
                    subprocess.call(vod_response_another_error_window + ['echo', vod_response_another_error])
                    sys.exit()
            else:
    ...
    def run(self):
        ...
        # start text
        print('Twitch VOD Downloader v1.2.0')
        print('Configuration:')
